    ...
    <div class="container my-3">
        <div class="row justify-content-center align-items-center">
            <div class="col-12 col-md-6 shadow p-3">
                ...
                <form method="post" action="{{ route('customer.updateprofile', [($id = auth()->user()->id)]) }}"
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <input id="image" type="file" class="w-100" name="image"
                            value="{{ old('image') }}" required autocomplete="image">
                    </div>
                    <div>
                        <img src="{{auth()->user()->image}}"  alt="" class="rounded-circle" width="100">
                    </div>
